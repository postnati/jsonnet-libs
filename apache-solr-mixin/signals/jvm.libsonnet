function(this)
  {
    ...
    signals: {
      ...
      // Cluster-overview variant of cpuLoad: keeps solr_cluster in the by-clause
      // and omits the '> 0' filter, so idle nodes still rank in the top-k.
      topCpuLoad: {
        name: 'Top nodes by CPU load',
        nameShort: 'CPU',
        type: 'gauge',
