          ...
          rules: [
            {
              ...
              annotations: {
                summary: 'More than %(alertsModelRequestErrorRate)s%% of all model requests are not successful.' % this.config,
                description:
            ...
            },
            {
              ...
              annotations: {
                summary: 'Batch queuing latency more than %(alertsBatchQueuingLatency)sµs.' % this.config,
                description:
